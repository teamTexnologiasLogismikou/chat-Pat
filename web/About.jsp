...
<html>
    ...
    <body background="images/chat2.jpg">
        ...
        <br/><br/>
        <button style="margin-left: 100px; height:25px; width:130px"class="btn btn-default btn-lg text-left" type="button" onclick=window.location.href="Home.jsp">Back</button>
    </body>
</html>
